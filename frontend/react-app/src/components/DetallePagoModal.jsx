                ...
                <div className="print-content" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
                  ...
                  <div style={{ 
                    ...
                    <p style={{ margin: '4px 0', color: '#6c757d', fontSize: '14px' }}>
                      <i className="bi bi-geo-alt-fill me-1" style={{ color: '#495057' }}></i>
                      {boleta.hotel.direccion}
                    </p>
                    <p style={{ margin: '4px 0', color: '#6c757d', fontSize: '14px' }}>
                      <i className="bi bi-telephone-fill me-1" style={{ color: '#495057' }}></i>
                      {boleta.hotel.telefono} 
                      <span className="mx-2">|</span>
                      <i className="bi bi-envelope-fill me-1" style={{ color: '#495057' }}></i>
                      {boleta.hotel.email}
                    </p>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <span style={{ fontSize: '14px', color: '#6c757d' }}>
                          <i className="bi bi-calendar3 me-1" style={{ color: '#495057' }}></i>
                      ...
                      <div className="card h-100">
                        <div className="card-body">
                          <h3 style={{ 
                            ...
                            <i className="bi bi-person-fill me-2" style={{ color: '#495057' }}></i>
                            Datos del Cliente
                          </h3>
                          <div style={{ marginBottom: '10px' }}>
                            <strong style={{ color: '#495057' }}>Nombre:</strong>
                            <span style={{ marginLeft: '8px', color: '#212529' }}>{boleta.cliente.nombre}</span>
                          </div>
                          <div>
                            <strong style={{ color: '#495057' }}>Email:</strong>
                            <span style={{ marginLeft: '8px', color: '#212529' }}>{boleta.cliente.email}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card h-100">
                        <div className="card-body">
                          <h3 style={{ 
                            ...
                            <i className="bi bi-credit-card-fill me-2" style={{ color: '#495057' }}></i>
                          ...
                          <div style={{ marginBottom: '10px' }}>
                            ...
                            <span className="badge bg-dark ms-2" style={{ 
                              fontSize: '12px',
                              textTransform: 'capitalize'
                            }}>
                              {boleta.pago.estado}
                  ...
                  <div style={{ marginBottom: '30px' }}>
                    <h3 style={{ 
                      ...
                      <i className="bi bi-list-ul me-2" style={{ color: '#495057' }}></i>
                      Detalle de la Reserva
                    </h3>
                        ...
                        <div className="card">
                          <div className="card-body">
                            <h4 style={{ 
                              ...
                              <i className="bi bi-sticky-fill me-2" style={{ color: '#495057' }}></i>
                              Observaciones
                            </h4>
