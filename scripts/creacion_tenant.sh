...
admin_stella AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('admin@hotel.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Administrador de Hoteles', TRUE)
  RETURNING usuario_id
),
admin_madero AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('admin2@hotel.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Administrador de Hoteles', TRUE)
  RETURNING usuario_id
),
gerente_stella AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('gerente_stella@hotel.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Valentina Rojas', TRUE)
  RETURNING usuario_id
),
gerente_madero AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('gerente_madero@hotel.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Matías Fuentes', TRUE)
  RETURNING usuario_id
),
recep_stella_centro AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('recep_centro@stella.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Alejandro González', TRUE)
  RETURNING usuario_id
),
recep_stella_aeropuerto AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('recep_aeropuerto@stella.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Daniela Pérez', TRUE)
  RETURNING usuario_id
),
recep_madero_centro AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('recep_centro@madero.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Benjamín Soto', TRUE)
  RETURNING usuario_id
),
recep_madero_bosque AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('recep_bosque@madero.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Laura Aguilera', TRUE)
  RETURNING usuario_id
),
huesped_stella_centro_1 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped1@stella.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'David Goggins', TRUE)
  RETURNING usuario_id
),
huesped_stella_centro_2 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped2@stella.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'María López', TRUE)
  RETURNING usuario_id
),
huesped_stella_aeropuerto_1 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped3@stella.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Carlos Pérez', TRUE)
  RETURNING usuario_id
),
huesped_stella_aeropuerto_2 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped4@stella.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Andrea Castillo', TRUE)
  RETURNING usuario_id
),
huesped_madero_centro_1 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped1@madero.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Lucario Martínez', TRUE)
  RETURNING usuario_id
),
huesped_madero_centro_2 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped2@madero.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Valeria Gómez', TRUE)
  RETURNING usuario_id
),
huesped_madero_bosque_1 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped3@madero.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Diego Hernández', TRUE)
  RETURNING usuario_id
),
huesped_madero_bosque_2 AS (
  INSERT INTO usuario (email, password_hash, nombre, activo)
  VALUES ('huesped4@madero.com', '$2b$10$Y2.3XqaGb3bO2CG.EZPR9.8maAVCDSMcze5wyFtSQNHs.Qzx.3sA2', 'Fernanda Silva', TRUE)
  RETURNING usuario_id
),
...
huesped_fichas AS (
  ...
  UNION ALL
  SELECT u.usuario_id, s.tenant_id, s.sucursal_id, 'María López', 'huesped2@stella.com', '+56930010002', '18222333-5', TRUE, now()
  FROM huesped_stella_centro_2 u, sucursal_stella_centro s
  UNION ALL
  SELECT u.usuario_id, s.tenant_id, s.sucursal_id, 'Carlos Pérez', 'huesped3@stella.com', '+56930010003', '20333444-7', TRUE, now()
  ...
  UNION ALL
  SELECT u.usuario_id, s.tenant_id, s.sucursal_id, 'Lucario Martínez', 'huesped1@madero.com', '+56930020001', '15333111-2', TRUE, now()
  FROM huesped_madero_centro_1 u, sucursal_madero_centro s
  UNION ALL
  SELECT u.usuario_id, s.tenant_id, s.sucursal_id, 'Valeria Gómez', 'huesped2@madero.com', '+56930020002', '17666444-3', TRUE, now()
  FROM huesped_madero_centro_2 u, sucursal_madero_centro s
  UNION ALL
  SELECT u.usuario_id, s.tenant_id, s.sucursal_id, 'Diego Hernández', 'huesped3@madero.com', '+56930020003', '18888777-5', TRUE, now()
